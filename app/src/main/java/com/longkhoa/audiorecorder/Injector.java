...
package com.longkhoa.audiorecorder;

import android.content.Context;

import com.longkhoa.audiorecorder.app.AppRecorder;
import com.longkhoa.audiorecorder.app.AppRecorderImpl;
import com.longkhoa.audiorecorder.app.browser.FileBrowserContract;
import com.longkhoa.audiorecorder.app.browser.FileBrowserPresenter;
import com.longkhoa.audiorecorder.app.lostrecords.LostRecordsContract;
import com.longkhoa.audiorecorder.app.lostrecords.LostRecordsPresenter;
import com.longkhoa.audiorecorder.app.moverecords.MoveRecordsViewModel;
import com.longkhoa.audiorecorder.app.settings.SettingsMapper;
import com.longkhoa.audiorecorder.app.setup.SetupContract;
import com.longkhoa.audiorecorder.app.setup.SetupPresenter;
import com.longkhoa.audiorecorder.app.trash.TrashContract;
import com.longkhoa.audiorecorder.app.trash.TrashPresenter;
import com.longkhoa.audiorecorder.audio.AudioWaveformVisualization;
import com.longkhoa.audiorecorder.audio.player.AudioPlayerNew;
import com.longkhoa.audiorecorder.audio.player.PlayerContractNew;
import com.longkhoa.audiorecorder.audio.recorder.AudioRecorder;
import com.longkhoa.audiorecorder.audio.recorder.ThreeGpRecorder;
import com.longkhoa.audiorecorder.audio.recorder.RecorderContract;
import com.longkhoa.audiorecorder.audio.recorder.WavRecorder;
import com.longkhoa.audiorecorder.data.FileRepository;
import com.longkhoa.audiorecorder.data.FileRepositoryImpl;
import com.longkhoa.audiorecorder.data.Prefs;
import com.longkhoa.audiorecorder.data.PrefsImpl;
import com.longkhoa.audiorecorder.data.database.LocalRepository;
import com.longkhoa.audiorecorder.data.database.LocalRepositoryImpl;
import com.longkhoa.audiorecorder.data.database.RecordsDataSource;
import com.longkhoa.audiorecorder.app.main.MainContract;
import com.longkhoa.audiorecorder.app.main.MainPresenter;
import com.longkhoa.audiorecorder.app.records.RecordsContract;
import com.longkhoa.audiorecorder.app.records.RecordsPresenter;
import com.longkhoa.audiorecorder.app.settings.SettingsContract;
import com.longkhoa.audiorecorder.app.settings.SettingsPresenter;
import com.longkhoa.audiorecorder.data.database.TrashDataSource;
